...
import by.matmux.instazoo.exceptions.ImageNotFoundException;
...
public class ImageUploadService {
    ...
    @Autowired
    public ImageUploadService(ImageModelDao imageModelDao, UserDao userDao, PostDao postDao) {
    ...
    public ImageModel uploadImageToUser(MultipartFile multipartFile, Principal principal) throws IOException {
        ...
        ImageModel userProfileImage = imageModelDao.findByPostId(user.getId()).orElse(null);
    ...
    public ImageModel uploadImageForPost(MultipartFile multipartFile, Principal principal, Long postId) throws  IOException{
        User user = getUserByPrincipal(principal);
